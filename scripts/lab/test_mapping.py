...
test_locations = ["Netherlands", "Sydney, Australia", "New York City, USA", "San Francisco, USA", "Los Angeles, CA", "Austria", "Berlin", "London, UK", "Zurich, Switzerland", "Nottingham, UK"]

for loc in test_locations:
    print(f"'{loc}' -> {get_region(loc)}")
