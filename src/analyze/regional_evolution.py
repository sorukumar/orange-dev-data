...
INPUT_PATH = os.path.join(WORK_DIR, "core", "contributors_rich.json")
OUTPUT_PATH = os.path.join(TRACKER_DIR, "stats_regional_evolution.json")

# Consolidated regional taxonomy
REGION_MAPPING = {
    # North America
    ...
    "perth": "Asia Pacific", "casablanca": "Africa",
    "morocco": "Africa", "lausanne": "Europe", "mempool": "North America",
    # Latin America
...
def main():
    print("--- Regional Evolution Analysis (New Architecture) ---")
    ...
    print(f"Generated {OUTPUT_PATH} with consolidated categories")
